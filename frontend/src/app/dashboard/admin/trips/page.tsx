                    ...
                    <button
                        ...
                        onClick={()=>{
                            exportCSV('seferler_tumu', filtered, [
                                ...
                                { key:'minutes_left', title:'Kalan (dk)', map:(r:Trip)=> minutesLeft(r.departure_time) },
                                { key:'status', title:'Durum', map:(r:Trip)=> {
                        ...
                        {paged.map(t=>{
                            ...
                            return (
                                <tr key={t.id} className={`border-t ${rowCls}`}>
                                    ...
                                    <td>
                                        {past && <span className="px-2 py-1 rounded-lg text-xs border">Geçti</span>}
                                        {(!past && closing) && <span className="px-2 py-1 rounded-lg text-xs border border-amber-300 bg-amber-100">Son Saat</span>}
                                        {(!past && !closing) && <span className="px-2 py-1 rounded-lg text-xs border">Normal</span>}
                                    </td>
                                    <td>{fmtTL(t.cost)}</td>
